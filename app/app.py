...
networks = {
    "hospitals": {
        1: {
            "name": "Meadow Brook Hospital",
            "epr": "Nexus",
            "pas": "Wards",
            "pacs": "Spark",
            "tie": "Echo",
            "profilePic": "MeadowBrookHospital.jpg",
        },
        2: {
            "name": "Sutton Bridge Hospital",
            "epr": "Nexus",
            "pas": "Cygnus",
            "pacs": "Quantum",
            "tie": "Flux",
            "profilePic": "SuttonBridgeHospital.jpg",
        },
        3: {
            "name": "Rose Hill Hospital",
            "epr": "AHHI",
            "pas": "Cygnus",
            "pacs": "Spark",
            "tie": "Velocity",
            "profilePic": "RoseHillHospital.jpg",
        },
        4: {
            "name": "Millfield Hospital",
            "epr": "Nexus",
            "pas": "Wards",
            "pacs": "Quantum",
            "tie": "Echo",
            "profilePic": "MillfieldHospital.jpg",
        },
    },
    "gps": {
        "Farm View Surgery": {"epr": "YRHealth"},
        "Hill Springs Surgery": {"epr": "ESSE"},
        "Cats Eye Surgery": {"epr": "Atom"},
        "Jump Gate Surgery": {"epr": "Atom"},
    },
    "socialCare": {
        "Ashtonshire Care": {"hub": "County Connex"},
        "Westbridgeshire Area": {"hub": "County Connex"},
        "Briarwoodshire Together": {"hub": "JUTS"},
        "Mapleshire Towns": {"hub": "JUTS"},
    },
    "industry": {
        "Eclipse Enterprises": {"products": "EPR, PACS, PAS"},
        "Skyline Solutions": {"products": "PAS"},
        "Summit Technologies": {"products": "Personal health apps"},
        "Horizon Holdings": {"products": "TIE"},
    },
}
...
async def envSelected(request):
    ...
    context["query_string"] = str(
        requestDic["scope"]["query_string"], "UTF-8"
    )[-1]
...
app = Starlette(
    debug=True, routes=routes, exception_handlers=exception_handlers
)
